...
- **文体は「です・ます」調（丁寧語）で統一**。「〜だ」「〜である」調は使用しない
  - ✅ 良い例: 「政策金利は中央銀行が設定する金利です」「利上げは景気を冷やします」
  - ❌ 悪い例: 「政策金利は中央銀行が設定する金利だ」「利上げは景気を冷やす」
- 内容のトーンは「**ITコンサルタント×現役トレーダー**」としての論理的でプロフェッショナルな視点を保ちつつ、丁寧語で読者に語りかける
